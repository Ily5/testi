class CallTranscript:
    ...
    test_asr_2 = "але ой извините пока нет щас я на работе извините пожалуйста я просто никак сейчас угу так а" \
                 ...
                 "стенкой в конце ряда слева будут там есть прям цвета разне "
    ...
    test_asr_22 = "алё нет вы ошибаетесь не знаю девушка вы мне звонили нет вы мне на протяжении наверно полугода " \
                  ...
                  "остановились я человека знать не знал но в итоге я с ним познакомился специально что бы его узнать "
    ...
    test_asr_25 = "ну удобно здравствуйте да у меня нету у меня нет интернета ой я не знаю я не знаю ещё у меня нет " \
                  "интернета я не пользуюсь интернетом "
    ...
    test_asr_28 = "ну я редко звоню просто я когда мне надо я звоню просто по работе я этой пользовался этой услугой " \
                  "но она мне что-то бонусы не возвращались мне на телефон на номер а деньги не будут за это " \
                  "сниматься ну давайте "

    test_asr_29 = "да здравствуйте ну да говорите всмысле давно не пользовался номером как это я им давно не " \
                  "пользовался дак они итак мне возвращаются ну она бесплатная или платная "

    test_asr_30 = "алё здравствуйте да удобно а в чём проблема как понять не пользовался я езжу не понял о чём речь " \
                  "что повторить хорошо хорошо"

    test_asr_31 = "ало да с каким именно у меня два у меня два на этом телефоне а ну не пользовалась ну просто у " \
                  "меня другой телефон я пока им не пользуюсь ну два номера два но с коронавирусом "

    test_asr_32 = "ало да всё что потребности нет я не хочу пользоваться пока а для чего ээ а какую сумму нужно " \
                  "потратить что бы был кеш бек там же определённую сумму нужно потратить или нет "

    test_asr_33 = "да ну вообще мы как бы пользуемся и вполне комфортно просто сейчас мы находимся в состоянии " \
    ...
    test_asr_44 = "нет я на работе спасибо "
